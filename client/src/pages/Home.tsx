...
import { ArrowRight, Download, Mail, MapPin, Github, Linkedin, Calendar, Code, Database, Terminal } from "lucide-react";
...
import profileFormal from "/images/profile-formal.jpeg";
import profileCasual from "/images/profile-casual.jpeg";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      {/* Hero Section */}
      <section id="hero" className="min-h-screen flex items-center relative z-10 pt-20">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex gap-6 mt-12 text-muted-foreground">
              <a href="https://github.com/Jaikay33" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                <Github size={24} />
              </a>
              <a href="#" className="hover:text-primary transition-colors">
                <Linkedin size={24} />
              </a>
              <a href="mailto:contact@jaikay.dev" className="hover:text-primary transition-colors">
                <Mail size={24} />
              </a>
            </div>
          </motion.div>
      ...
      {/* Experience Section */}
      <Section id="experience" title="Experience" subtitle="My professional journey and hackathons.">
        <div className="relative border-l border-white/10 ml-4 md:ml-12 space-y-12">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 mb-2">
              ...
              <Badge variant="outline" className="w-fit border-primary/30 text-primary bg-primary/5">CodeAlpha</Badge>
            </div>
      ...
      <Section id="skills" title="Skills" className="bg-white/[0.02]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { name: "Python", icon: <Terminal className="w-8 h-8 text-yellow-500" />, level: 90 },
            { name: "Data Analysis", icon: <Database className="w-8 h-8 text-blue-500" />, level: 85 },
            { name: "Pandas & NumPy", icon: <Code className="w-8 h-8 text-green-500" />, level: 80 },
            { name: "Streamlit", icon: <ArrowRight className="w-8 h-8 text-red-500" />, level: 75 },
          ].map((skill, i) => (
            <motion.div
              key={skill.name}
          ...
          <div className="grid md:grid-cols-2 gap-12 relative z-10">
            <div>
              ...
              <div className="space-y-6">
                <a href="mailto:contact@jaikay.dev" className="flex items-center gap-4 text-foreground hover:text-primary transition-colors group">
      ...
      <footer className="py-8 border-t border-white/5 text-center text-muted-foreground text-sm">
        <p>&copy; {new Date().getFullYear()} Jaikay Kumar. All rights reserved.</p>
      </footer>
    </div>
  );
}
